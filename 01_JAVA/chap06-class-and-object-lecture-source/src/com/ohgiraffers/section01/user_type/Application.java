...
public class Application {
    ...
    public static void main(String[] args) {
         ...
         * 2. 모든 회원 정보를 인자로 메소드 호출시 값을 전당해야만하면 너무 많은 값들을 인자로
         * 전달해야해서 한 눈에 안 들어온다.
         * 3. 리턴은 1 개의 값만 가능하기 때문에 회원정보를 묶어서 리턴값으로 사용할 수 없다.
         * (서로 다른 자료형이기 때문에) */

        /* 사용자 정의의 자료형 사용하기
         * 2-1. 변수 선언 및 객체 생성 */
        /*자료형,변수명 = new 클래스명(); < 지금까지 사용한 구문은 객체(인스턴스)를 생성하는 구문이다.
         * 사용자 정의의 자료형인 클래스를 이용하기 위해서는 new 연산자로 heap에 할당해야한다.
         * 객체를 생성하게되면 클래스에 정의한 필드와 메소드 대로 객체가 생성된다.
         ...
         * '_' 참조연산자라고 하는데 래퍼런스 변수가 참고하고 있는 주소로 접근한다는 의미를 가진다.
